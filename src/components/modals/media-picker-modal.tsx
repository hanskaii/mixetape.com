...
export function MediaPickerDialog({
  ...
  const isOpen = open ?? showModal ?? false;
  ...
  return (
    <Modal
      ...
      className="max-w-2xl max-h-[85vh] flex flex-col p-4 sm:p-6 gap-4"
    >
      <ModalHeader className="pb-0">
        <ModalTitle className="text-sm font-semibold flex items-center gap-2">
      ...
      <div className="flex items-center justify-between gap-3 pt-1">
        ...
        <label className="cursor-pointer">
          <input
            ...
            disabled={uploading}
          />
          <span className="inline-flex items-center gap-1.5 h-7 px-3 rounded-lg text-xs font-semibold bg-primary text-primary-foreground hover:opacity-90 transition-opacity cursor-pointer">
            {uploading ? (
              <>
